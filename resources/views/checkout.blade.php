                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input @if($errors->has('address')) invalid @endif">
                                ...
                                <input type="text" name="address" placeholder="Street Address" class="checkout__input__add" value="{{old('address')}}">
